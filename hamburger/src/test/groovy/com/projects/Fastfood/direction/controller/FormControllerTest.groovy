...
class FormControllerTest extends Specification {
    ...
    private FastfoodRecommendationService fastfoodRecommendationService = Mock()
    private List<OutputDto> outputDtoList

    def setup() {
        // FormController MockMvc 객체로 만든다.
        mockMvc = MockMvcBuilders.standaloneSetup(new FormController(fastfoodRecommendationService))
                .build()
    ...
    def "POST /search"() {
        ...
        then:
        1 * fastfoodRecommendationService.recommendFastfoodList(argument -> {
